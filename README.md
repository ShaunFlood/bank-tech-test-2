...
Makers had set out what is require of the program:
...
This would be the MVP of the entire project:


I wanted to achieve to do more than the MVP by implementing this:


Here is the plan for the the project:
